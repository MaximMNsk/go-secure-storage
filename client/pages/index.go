...
func (m *Menu) Update(msg tea.Msg) (tea.Model, tea.Cmd) {
	...
	case tea.KeyMsg:
		...
		case "enter":
			...
			if ok {
				go func() {
					ProxyRouterChan <- messages.NewMessage(messages.Route, string(i), ``)
				}()
			}
			return m, tea.Quit
		}
...
func (m *Menu) Show(storage remote.Storage, routerCh chan messages.Message, mess string) error {
